...
def train():
    model_path = './models/'+set_size+'/fma.crnn6'
    ...
    try:
        ...
        model.add(layers.Reshape((21, 32)))
    ...
    try:
        dump(history.history, "./history/" + set_size + '/' + 'crnn6.joblib')
    except:
        os.makedirs("./history/" + set_size)
        dump(history.history, "./history/" + set_size + '/' + 'crnn6.joblib')
    model.save('./models/'+set_size+'/fma.crnn6')
