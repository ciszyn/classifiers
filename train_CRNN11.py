...
import os
from modelScripts.CRNN11 import getModel
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'


def train():
    model_path = './models/'+set_size+'/fma.crnn11'
    ...
    try:
        dump(history.history, "./history/" + set_size + '/' + 'crnn11.joblib')
    except:
        os.makedirs("./history/" + set_size)
        dump(history.history, "./history/" + set_size + '/' + 'crnn11.joblib')
    model.save('./models/'+set_size+'/fma.crnn11')
