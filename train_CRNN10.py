from modelScripts.CRNN10 import getModel
...
def train():
    model_path = './models/'+set_size+'/fma.crnn10'
    ...
    try:
        dump(history.history, "./history/" + set_size + '/' + 'crnn10.joblib')
    except:
        os.makedirs("./history/" + set_size)
        dump(history.history, "./history/" + set_size + '/' + 'crnn10.joblib')
    model.save('./models/'+set_size+'/fma.crnn10')
